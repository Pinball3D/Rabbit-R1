    ...
    public static class ReflectionAccessors {
        ...
        public Long getChildId(AccessibilityNodeInfo accessibilityNodeInfo, int i) {
            ...
            if (method != null) {
                ...
                } catch (ArrayIndexOutOfBoundsException | InvocationTargetException e3) {
                    Log.w(AccessibilityViewEmbedder.TAG, "The longArrayGetIndex method threw an exception when invoked.", e3);
