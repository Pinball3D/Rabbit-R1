...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2290alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        long IntSize = IntSizeKt.IntSize(IntSize.m5043getWidthimpl(space) - IntSize.m5043getWidthimpl(size), IntSize.m5042getHeightimpl(space) - IntSize.m5042getHeightimpl(size));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5043getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5042getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
