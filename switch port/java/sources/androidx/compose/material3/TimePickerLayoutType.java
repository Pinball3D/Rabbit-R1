...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m1593constructorimpl(0);
    private static final int Vertical = m1593constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m1592boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m1593constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1594equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1595equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m1594equalsimpl(this.value, obj);
    }
    ...
    public static String m1597toStringimpl(int i) {
        return m1595equalsimpl0(i, Horizontal) ? "Horizontal" : m1595equalsimpl0(i, Vertical) ? "Vertical" : "Unknown";
    }
}
