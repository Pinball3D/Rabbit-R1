    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L19:
            ...
            kotlin.ResultKt.throwOnFailure(r7)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            goto L5c
        L2f:
        ...
        L37:
            ...
            r7.<init>()
            kotlinx.coroutines.flow.Flow r2 = r5.$this_take$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1 r4 = new kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            int r5 = r5.$count$inlined     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            r4.<init>(r7, r5, r6)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            kotlinx.coroutines.flow.FlowCollector r4 = (kotlinx.coroutines.flow.FlowCollector) r4     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            r0.L$0 = r6     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            r0.label = r3     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            java.lang.Object r5 = r2.collect(r4, r0)     // Catch: kotlinx.coroutines.flow.internal.AbortFlowException -> L58
            if (r5 != r1) goto L5c
            return r1
        L58:
            r5 = move-exception
