...
public interface SendChannel<E> {
    ...
    Object mo7202trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m7222isSuccessimpl(mo7202trySendJP2dKIU)) {
                return true;
            }
            Throwable m7216exceptionOrNullimpl = ChannelResult.m7216exceptionOrNullimpl(mo7202trySendJP2dKIU);
