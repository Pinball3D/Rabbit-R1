...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo7015minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m7161minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo7014elapsedNowUwyO8pc() {
        return Duration.m7059minusLRDsOJo(this.mark.mo7014elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo7017plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m7060plusLRDsOJo(this.adjustment, duration), null);
    }
}
