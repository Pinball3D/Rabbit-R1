...
.method protected decode([BIZ)Landroidx/media3/extractor/text/Subtitle;
    ...
    :try_start_0
    iget-object v1, v1, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->xmlParserFactory:Lorg/xmlpull/v1/XmlPullParserFactory;
    ...
    sget-object v4, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->DEFAULT_FRAME_AND_TICK_RATE:Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;

    sget-object v5, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->DEFAULT_CELL_RESOLUTION:Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;
    ...
    .line 141
    invoke-static {v1}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseFrameAndTickRates(Lorg/xmlpull/v1/XmlPullParser;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;
    ...
    .line 142
    invoke-static {v1, v0}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseCellResolution(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;

    move-result-object v5

    .line 143
    invoke-static {v1}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseTtsExtent(Lorg/xmlpull/v1/XmlPullParser;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$TtsExtent;
    ...
    .line 145
    invoke-static {v14}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->isSupportedTag(Ljava/lang/String;)Z
    ...
    .line 149
    invoke-static/range {v2 .. v7}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseHeader(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Map;Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;Landroidx/media3/extractor/text/ttml/TtmlDecoder$TtsExtent;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    :try_end_2
    ...
    .line 152
    :try_start_3
    invoke-static {v1, v2, v9, v14}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseNode(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    ...
    .line 155
    invoke-virtual {v2, v0}, Landroidx/media3/extractor/text/ttml/TtmlNode;->addChild(Landroidx/media3/extractor/text/ttml/TtmlNode;)V
    :try_end_3
    ...
    invoke-static {v2}, Landroidx/media3/extractor/text/ttml/TtmlNode;->buildTextNode(Ljava/lang/String;)Landroidx/media3/extractor/text/ttml/TtmlNode;

    move-result-object v2

    invoke-virtual {v0, v2}, Landroidx/media3/extractor/text/ttml/TtmlNode;->addChild(Landroidx/media3/extractor/text/ttml/TtmlNode;)V
