    ...
    */
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i2 & i3)) {
                DeviceControl$Companion$$ExternalSyntheticLambda3 deviceControl$Companion$$ExternalSyntheticLambda3 = (Object) this.array.get(i3 & i);
                if (deviceControl$Companion$$ExternalSyntheticLambda3 != null && !(deviceControl$Companion$$ExternalSyntheticLambda3 instanceof Placeholder)) {
                    arrayList.add(transform.invoke(deviceControl$Companion$$ExternalSyntheticLambda3));
                }
                i++;
            } else {
                return arrayList;
