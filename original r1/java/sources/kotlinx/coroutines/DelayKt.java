...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo7258scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m7188delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m7189toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m7189toDelayMillisLRDsOJo(long j) {
        if (Duration.m7023compareToLRDsOJo(j, Duration.INSTANCE.m7127getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m7042getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
