...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m5698constructorimpl = Result.m5698constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5698constructorimpl = Result.m5698constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5704isFailureimpl(m5698constructorimpl) ? null : m5698constructorimpl);
        if (bool != null) {
