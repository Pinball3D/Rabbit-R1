...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo7206receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo7206receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo7207tryReceivePtdJZtk() {
        return this._channel.mo7207tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo7202trySendJP2dKIU(E element) {
        return this._channel.mo7202trySendJP2dKIU(element);
    }
