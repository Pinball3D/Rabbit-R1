...
public final class FragmentComplianceBinding implements ViewBinding {
    ...
    private FragmentComplianceBinding(FrameLayout frameLayout, CanBackLabelView canBackLabelView, ScrollBarExtView scrollBarExtView, SubsamplingScaleImageView subsamplingScaleImageView, ScrollView scrollView) {
    ...
    public static FragmentComplianceBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentComplianceBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
    ...
    public static FragmentComplianceBinding bind(View view) {
        ...
        if (canBackLabelView != null) {
            ...
            if (scrollBarExtView != null) {
                ...
                if (subsamplingScaleImageView != null) {
                    ...
                    if (scrollView != null) {
                        return new FragmentComplianceBinding((FrameLayout) view, canBackLabelView, scrollBarExtView, subsamplingScaleImageView, scrollView);
                    }
                }
            }
        }
