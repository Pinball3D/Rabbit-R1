...
public final class PaintingStyle {
    ...
    private static final int Fill = m2894constructorimpl(0);
    private static final int Stroke = m2894constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PaintingStyle m2893boximpl(int i) {
    ...
    public static boolean m2895equalsimpl(int i, Object obj) {
        return (obj instanceof PaintingStyle) && i == ((PaintingStyle) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2896equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2897hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2895equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2897hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2900getFillTiuSbCo() {
            return PaintingStyle.Fill;
        }

        /* renamed from: getStroke-TiuSbCo, reason: not valid java name */
        public final int m2901getStrokeTiuSbCo() {
            return PaintingStyle.Stroke;
        }
    }

    public String toString() {
        return m2898toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2898toStringimpl(int i) {
        return m2896equalsimpl0(i, Fill) ? "Fill" : m2896equalsimpl0(i, Stroke) ? "Stroke" : "Unknown";
    }
}
