...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m5048getZeroYbymL2g();
    ...
    public final void m3258drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m5043getWidthimpl(size) > imageBitmap.getWidth() || IntSize.m5042getHeightimpl(size) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2861ImageBitmapx__hDU$default(IntSize.m5043getWidthimpl(size), IntSize.m5042getHeightimpl(size), 0, false, null, 28, null);
        ...
        long m5053toSizeozmzZPI = IntSizeKt.m5053toSizeozmzZPI(size);
        ...
        drawParams2.m3106setSizeuvyYCjk(m5053toSizeozmzZPI);
        canvas.save();
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.m3166drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.m3177drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m2665getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m2556getClear0nO6VwU(), 62, null);
    }
}
