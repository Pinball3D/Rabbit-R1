...
final class RequiredMinIntrinsicWidthModifier implements IntrinsicSizeModifier {
    ...
    public long mo444calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long j) {
        ...
        return Constraints.INSTANCE.m4849fixedWidthOenEA2s(measurable.minIntrinsicWidth(Constraints.m4838getMaxHeightimpl(j)));
    }
