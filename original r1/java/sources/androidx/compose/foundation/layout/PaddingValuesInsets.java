...
final class PaddingValuesInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo329roundToPx0680j_4(this.paddingValues.mo441calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo329roundToPx0680j_4(this.paddingValues.getTop());
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo329roundToPx0680j_4(this.paddingValues.mo442calculateRightPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo329roundToPx0680j_4(this.paddingValues.getBottom());
    }

    public String toString() {
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        return "PaddingValues(" + ((Object) Dp.m4894toStringimpl(this.paddingValues.mo441calculateLeftPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m4894toStringimpl(this.paddingValues.getTop())) + ", " + ((Object) Dp.m4894toStringimpl(this.paddingValues.mo442calculateRightPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m4894toStringimpl(this.paddingValues.getBottom())) + ')';
    }
