...
final class SimpleFocusLinearLayoutManager$onSearchFailed$1 extends Lambda implements Function2<Integer, RecyclerView.State, Unit> {
    public static final SimpleFocusLinearLayoutManager$onSearchFailed$1 INSTANCE = new SimpleFocusLinearLayoutManager$onSearchFailed$1();

    SimpleFocusLinearLayoutManager$onSearchFailed$1() {
        super(2);
    }
