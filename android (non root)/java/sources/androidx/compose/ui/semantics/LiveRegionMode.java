...
public final class LiveRegionMode {
    ...
    private static final int Polite = m4241constructorimpl(0);
    private static final int Assertive = m4241constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m4240boximpl(int i) {
        return new LiveRegionMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4241constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4242equalsimpl(int i, Object obj) {
        return (obj instanceof LiveRegionMode) && i == ((LiveRegionMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m4243equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m4244hashCodeimpl(int i) {
    ...
    public static String m4245toStringimpl(int i) {
        return m4243equalsimpl0(i, Polite) ? "Polite" : m4243equalsimpl0(i, Assertive) ? "Assertive" : "Unknown";
    }
}
