...
public final class ClipOp {
    ...
    private static final int Difference = m2621constructorimpl(0);
    private static final int Intersect = m2621constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ClipOp m2620boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static String m2625toStringimpl(int i) {
        return m2623equalsimpl0(i, Difference) ? "Difference" : m2623equalsimpl0(i, Intersect) ? "Intersect" : "Unknown";
    }
}
