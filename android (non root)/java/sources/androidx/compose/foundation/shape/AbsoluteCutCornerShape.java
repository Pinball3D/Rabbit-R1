...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo726createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2469getWidthimpl(size) - topEnd, 0.0f);
        Path.lineTo(Size.m2469getWidthimpl(size), topEnd);
        Path.lineTo(Size.m2469getWidthimpl(size), Size.m2466getHeightimpl(size) - bottomEnd);
        Path.lineTo(Size.m2469getWidthimpl(size) - bottomEnd, Size.m2466getHeightimpl(size));
        Path.lineTo(bottomStart, Size.m2466getHeightimpl(size));
        Path.lineTo(0.0f, Size.m2466getHeightimpl(size) - bottomStart);
        Path.close();
