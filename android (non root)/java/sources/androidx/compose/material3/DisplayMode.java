...
public final class DisplayMode {
    ...
    private static final int Picker = m1177constructorimpl(0);
    private static final int Input = m1177constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m1176boximpl(int i) {
    ...
    public static String m1181toStringimpl(int i) {
        return m1179equalsimpl0(i, Picker) ? "Picker" : m1179equalsimpl0(i, Input) ? "Input" : "Unknown";
    }
}
