...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo344onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m2401getYimpl(available) > 0.0f) {
    ...
    public long mo343onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (Offset.m2401getYimpl(available) < 0.0f || Offset.m2401getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
        ...
        if (Offset.m2401getYimpl(available) > 0.0f) {
    ...
    */
    public java.lang.Object mo342onPostFlingRZ2iAVY(long r10, long r12, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r14) {
        ...
        L55:
            ...
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r14 = r9.this$0
            androidx.compose.material3.TopAppBarState r14 = r14.getState()
            float r12 = androidx.compose.ui.unit.Velocity.m5109getYimpl(r12)
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r13 = r9.this$0
        ...
        L80:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo342onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
