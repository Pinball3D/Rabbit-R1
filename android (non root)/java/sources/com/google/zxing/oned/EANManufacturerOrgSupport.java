...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{HttpStatusCodeRange.DEFAULT_MIN, 509}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{773}, "UY");
            add(new int[]{775}, "PE");
            add(new int[]{NetworksAdapter.VIEW_TYPE_WIFI_ITEM}, "BO");
            add(new int[]{779}, "AR");
            add(new int[]{780}, "CL");
            add(new int[]{784}, "PY");
            add(new int[]{785}, "PE");
            ...
            add(new int[]{880}, "KR");
            add(new int[]{885}, "TH");
            add(new int[]{NetworksAdapter.VIEW_TYPE_NETWORKS_LABEL}, "SG");
            add(new int[]{890}, "IN");
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, "ID");
