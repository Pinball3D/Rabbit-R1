...
public final class AtomParsers {
    ...
    */
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
        ...
        Format.Builder drmInitData5 = new Format.Builder().setId(i4).setSampleMimeType(str4).setCodecs(str5).setWidth(readUnsignedShort).setHeight(i21).setPixelWidthHeightRatio(f4).setRotationDegrees(i5).setProjectionData(bArr).setStereoMode(i15).setInitializationData(list4).setDrmInitData(drmInitData4);
