...
class GroupingKt__GroupingKt extends GroupingKt__GroupingJVMKt {
    ...
    public static final <T, K, R> Map<K, R> aggregate(Grouping<T, ? extends K> grouping, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            DeviceControl$Companion$$ExternalSyntheticLambda3 deviceControl$Companion$$ExternalSyntheticLambda3 = (Object) linkedHashMap.get(keyOf);
            linkedHashMap.put(keyOf, operation.invoke(keyOf, deviceControl$Companion$$ExternalSyntheticLambda3, next, Boolean.valueOf(deviceControl$Companion$$ExternalSyntheticLambda3 == null && !linkedHashMap.containsKey(keyOf))));
        }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M aggregateTo(Grouping<T, ? extends K> grouping, M destination, Function4<? super K, ? super R, ? super T, ? super Boolean, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ?? next = sourceIterator.next();
            Object keyOf = grouping.keyOf(next);
            DeviceControl$Companion$$ExternalSyntheticLambda3 deviceControl$Companion$$ExternalSyntheticLambda3 = (Object) destination.get(keyOf);
            destination.put(keyOf, operation.invoke(keyOf, deviceControl$Companion$$ExternalSyntheticLambda3, next, Boolean.valueOf(deviceControl$Companion$$ExternalSyntheticLambda3 == null && !destination.containsKey(keyOf))));
        }
        return destination;
    }
    ...
    public static final <T, K, R> Map<K, R> fold(Grouping<T, ? extends K> grouping, R r, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            DeviceControl$Companion$$ExternalSyntheticLambda4 deviceControl$Companion$$ExternalSyntheticLambda4 = (Object) linkedHashMap.get(keyOf);
            if (deviceControl$Companion$$ExternalSyntheticLambda4 == null && !linkedHashMap.containsKey(keyOf)) {
                deviceControl$Companion$$ExternalSyntheticLambda4 = (Object) r;
            }
            linkedHashMap.put(keyOf, operation.invoke(deviceControl$Companion$$ExternalSyntheticLambda4, next));
        }
        return linkedHashMap;
    }
    ...
    public static final <T, K, R, M extends Map<? super K, R>> M foldTo(Grouping<T, ? extends K> grouping, M destination, R r, Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ?? next = sourceIterator.next();
            K keyOf = grouping.keyOf(next);
            DeviceControl$Companion$$ExternalSyntheticLambda4 deviceControl$Companion$$ExternalSyntheticLambda4 = (Object) destination.get(keyOf);
            if (deviceControl$Companion$$ExternalSyntheticLambda4 == null && !destination.containsKey(keyOf)) {
                deviceControl$Companion$$ExternalSyntheticLambda4 = (Object) r;
            }
            destination.put(keyOf, operation.invoke(deviceControl$Companion$$ExternalSyntheticLambda4, next));
        }
        return destination;
    }
    ...
    public static final <S, T extends S, K> Map<K, S> reduce(Grouping<T, ? extends K> grouping, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            DeviceControl$Companion$$ExternalSyntheticLambda3 deviceControl$Companion$$ExternalSyntheticLambda3 = (Object) linkedHashMap.get(keyOf);
            if (!(deviceControl$Companion$$ExternalSyntheticLambda3 == null && !linkedHashMap.containsKey(keyOf))) {
                s = operation.invoke(keyOf, deviceControl$Companion$$ExternalSyntheticLambda3, s);
            }
    ...
    public static final <S, T extends S, K, M extends Map<? super K, S>> M reduceTo(Grouping<T, ? extends K> grouping, M destination, Function3<? super K, ? super S, ? super T, ? extends S> operation) {
        ...
        while (sourceIterator.hasNext()) {
            ...
            Object keyOf = grouping.keyOf(s);
            DeviceControl$Companion$$ExternalSyntheticLambda3 deviceControl$Companion$$ExternalSyntheticLambda3 = (Object) destination.get(keyOf);
            if (!(deviceControl$Companion$$ExternalSyntheticLambda3 == null && !destination.containsKey(keyOf))) {
                s = operation.invoke(keyOf, deviceControl$Companion$$ExternalSyntheticLambda3, s);
            }
