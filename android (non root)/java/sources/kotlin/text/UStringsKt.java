...
public final class UStringsKt {
    ...
    public static final String m7011toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m7013toStringolVBNx4(short s, int i) {
    ...
    public static final String m7012toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m7010toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m5793constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m5710boximpl(UByte.m5716constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m5793constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m5973boximpl(UShort.m5979constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m5793constructorimpl = UInt.m5793constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = Integer.divideUnsigned(-1, m5793constructorimpl);
                    if (Integer.compareUnsigned(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int m5793constructorimpl2 = UInt.m5793constructorimpl(i3 * m5793constructorimpl);
            int m5793constructorimpl3 = UInt.m5793constructorimpl(UInt.m5793constructorimpl(digitOf) + m5793constructorimpl2);
            if (Integer.compareUnsigned(m5793constructorimpl3, m5793constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = m5793constructorimpl3;
        }
        return UInt.m5787boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m5872constructorimpl = ULong.m5872constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = Long.divideUnsigned(-1L, m5872constructorimpl);
                    if (Long.compareUnsigned(j, j2) > 0) {
                    }
                }
                return null;
            }
            long m5872constructorimpl2 = ULong.m5872constructorimpl(j * m5872constructorimpl);
            long m5872constructorimpl3 = ULong.m5872constructorimpl(ULong.m5872constructorimpl(UInt.m5793constructorimpl(r13) & KeyboardMap.kValueMask) + m5872constructorimpl2);
            if (Long.compareUnsigned(m5872constructorimpl3, m5872constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = m5872constructorimpl3;
        }
